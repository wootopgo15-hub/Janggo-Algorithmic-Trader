...
async function test() {
  ...
  console.log('--- Hedge Limit Stop Loss ---');
  try {
    const req1 = client.createOrderRequest('BTC/USDT:USDT', 'market', 'buy', 1.5, undefined, { hedged: true, marginMode: 'cross', presetStopLossPrice: 50000 });
    console.log(req1);
